...
import { getCareerPageData } from 'lib/copy'
  ...
  return (
    <Layout background="light" navigationData={navigationData}>
      <Head>
        ...
        {/* Primary Meta Tags */}
        <link rel="canonical" href="https://www.freeagency.com/careers/" />
        ...
        />
        <meta property="og:url" content="https://www.freeagency.com/careers/" />
...
export const getStaticProps: GetStaticProps = async () => {
  const { sections, meta } = getCareerPageData()
